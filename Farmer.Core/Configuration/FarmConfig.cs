...
namespace Farmer.Core.Configuration
{
   public partial class FarmConfig:IConfigurationSectionHandler
    {
        /// <summary>
        ...
        /// <summary>
        /// 用户代理数据库路径Path to database with user agent strings
        /// </summary>
